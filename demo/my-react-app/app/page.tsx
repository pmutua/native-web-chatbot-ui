...
const ChatBotComponent = () => {
  ...
  return null; // Since the chatbot is added to the body, no need to render anything here.
};
...
## 9. CSS Loading
Make sure that the CSS file (@equity/.css) is available and properly linked, as the chatbot config includes a custom CSS path.
